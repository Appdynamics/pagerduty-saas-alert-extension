...
public class EndpointBuilderTest {
    ...
    public static final String HRV_URL = "https://adppe.saas.appdynamics.com/controller/rest/applications/1/problems/healthrule-violations?time-range-type=BEFORE_NOW&duration-in-mins=2&output=XML";
    ...
    public void testHealthRuleViolationsEndpoint(){
        ...
        Customer customer = createCustomerConfig();
        String url = builder.buildHealthRulesViolationEndpoint(baseConfig,customer,1);
        Assert.assertTrue(HRV_URL.equals(url));
    }

    private Customer createCustomerConfig() {
        Customer customer = new Customer();
        customer.setSaasHost("adppe.saas.appdynamics.com");
        return customer;
    }
    ...
    private Configuration createBaseConfig() {
        ...
        baseConfig.setScheduleInterval(120);
        return baseConfig;
